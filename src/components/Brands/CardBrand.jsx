...
function cardbrand({imageLogo, title}) {
  return (
    ...
    <div className="container flex flex-col p-3 text-sm text-center">
      <div>
        <img src={imageLogo} alt="" className="container flex flex-col border-solid rounded-xl font-dynapuff text-themeMainBrown sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4"/> 
      </div>
      <div>
        <h4>{title}</h4>
      </div>
