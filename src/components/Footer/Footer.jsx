...
import logo from "../../assets/img/logo.svg";
    ...
    const Footer = () => {
      return (
        <footer className="container-fluid bg-[#FFD880] flex justify-center">
            ...
            <div className="text-end py-14 ml-40 text-gray-700 p-4 font-dynapuff text-themeMainBrown fixed;">
                (011) 5555-4444 
            </div>
            <button className="mt-20 font-dynapuff text-themeMainBrown fixed bg-[#d97706] py-2 px-4 border rounded hover:bg-transparent">
                Order a call !
            </button>                 
